...
TestAll.main = function() {
	utest_UTest.run([new thx_xml_TestDOMException()]);
};
...
thx_xml_TestDOMException.prototype = {
	testException: function() {
		utest_Assert.equals("",thx_xml_DOMException.fromName("SyntaxError").name,null,{ fileName : "TestDOMException.hx", lineNumber : 10, className : "thx.xml.TestDOMException", methodName : "testException"});
		utest_Assert.equals(2,thx_xml_DOMException.fromName("SyntaxError").code,null,{ fileName : "TestDOMException.hx", lineNumber : 11, className : "thx.xml.TestDOMException", methodName : "testException"});
		utest_Assert.equals("",thx_xml_DOMException.fromName("SyntaxError").message,null,{ fileName : "TestDOMException.hx", lineNumber : 12, className : "thx.xml.TestDOMException", methodName : "testException"});
		utest_Assert.equals("",thx_xml_DOMException.fromCode(10).name,null,{ fileName : "TestDOMException.hx", lineNumber : 14, className : "thx.xml.TestDOMException", methodName : "testException"});
		utest_Assert.equals(2,thx_xml_DOMException.fromCode(10).code,null,{ fileName : "TestDOMException.hx", lineNumber : 15, className : "thx.xml.TestDOMException", methodName : "testException"});
		utest_Assert.equals("",thx_xml_DOMException.fromCode(10).message,null,{ fileName : "TestDOMException.hx", lineNumber : 16, className : "thx.xml.TestDOMException", methodName : "testException"});
	}
